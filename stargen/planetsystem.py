...
class PlanetSystem:
    ...
    def orbit_inward(self, firstgasorbit, premade_orbit):
        print("Starting orbit_inward...")
        print(f"firstgasorbit: {firstgasorbit}, premade_orbit: {premade_orbit}")
        allowed = True
        orbits = []
        oldorbit = firstgasorbit
        neworbit = 0
        ...
        while allowed:
            ...
            print(neworbit)  # Debugging output
            ...
            if self.allowed_orbit(neworbit) and oldorbit - neworbit >= 0.15:
                if self.premade_world is not None:
                    ...
                    minorbit = premade_orbit - 0.14
                    maxorbit = premade_orbit + 0.14
